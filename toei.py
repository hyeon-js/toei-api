...
class Toei:
    def get_running_info(self, lineName):
        stns = self.get_station_list(lineName)
        data = self.get_train_list(lineName)
        result = []
    ...
    def get_station_list(self, lineName):
        if lineName == 'Asakusa':
    ...
    def get_train_list(self, lineName):
